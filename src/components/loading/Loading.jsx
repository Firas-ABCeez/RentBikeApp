  ...
  return (
    <div className={`flex items-center justify-center min-h-screen bg-[#fbfdfb]`}>
      <div className="text-center">
        <h1 className='text-7xl font-bold mb-10 poetsen-one-regular bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent'>ShareBike App <i className='text-sm font-thin'>Beta</i></h1>
        <div style={{
